...
const researched1 = [
  { title: 'Introduction', excerpt: 'Introduction', url: '/webservice/#/Introduction', link: '/webservice/#/Introduction#Main', paragraph: 'This Website is intended to be a guide for those who want to start their own ecommerce website or event a personal blog, also this website is meant to everyone who is learning about software-programming. In this website you can find my journey on build my own website and also you can find some tips and tricks that I have learned along the way. The tootls and technologies that I have used are mainly free and open source, so you can use them too. Having said that, I hope you enjoy this website and if you have any questions or suggestions, please feel free to contact me.' },
  { title: 'Ecommerce', excerpt: 'Ecommerce', url: '/webservice/#/Firstproject', link: '/webservice/#/Firstproject#Summary', paragraph: 'The ecommerce is one of the most common React web application a developer can be asked to build. Here is why knowing how to properly craft an ecommerce application from the ground up can be considered a crucial skill. Over the last few years, several libraries have been built to help developers reach this goal effortlessly. Specifically, Snipcart is the solution you are looking for. Not only does it allow you to set up an ecommerce in a few minutes, but it is also a secure, reliable, and advanced solution. Read this article instead, if you want to build a Next.js ecommerce.' },
  { title: 'Earn Market', excerpt: 'EarnMrket', url: '/webservice/#/Secondproject', link: '/webservice/#/Secondproject#Services', paragraph:'Earn Market is a brand and business that provides E-commerce & E-business services to companies or start-ups which are migrating their business to the digital world. We provide services.' },
  ...
  { title: 'Aesthetics', excerpt: 'Aesthetics', url: '/webservice/#/Fourproject', link: '/webservice/#/Fourproject#Design', paragraph: 'Web design is an important factor when it comes to websites, and even more so for eCommerce websites. A successful eCommerce web design can help give customers a better experience and potentially lead to more sales. In this page, we will talk through a few ideas on how you can make eCommerce web design improvements on your website.' },
  { title: 'Ux', excerpt: 'UxDesign', url: '/webservice/#/Fiveproject', link: '/webservice/#/Fiveproject#DesignUX', paragraph: 'UX design is the process of creating products that provide meaningful and relevant experiences to users. This involves the design of the entire process of acquiring and integrating the product, including aspects of branding, design, usability, and function.' },
  { title: 'Performance', excerpt: 'Performance', url: '/webservice/#/webservice/#/Finalmodule', link: '/webservice/#/Finalmodule#SpeedTesting', paragraph: 'Performance is a key factor in the success of any website. It is important to make sure that your website is fast and responsive. This is especially true for eCommerce websites, as a slow website can lead to a poor user experience and lost sales. In this page, we will talk through a few ideas on how you can improve the performance of your eCommerce website.' },
  { title: 'Introduction to react', excerpt: 'React', url: '/webservice/#/Designskills', link: '/webservice/#/Designskills#Languages', paragraph: 'React is a JavaScript library for building user interfaces. It is maintained by Facebook and a community of individual developers and companies. React can be used as a base in the development of single-page or mobile applications.' },
  { title: 'JX language', excerpt: 'language', url: '/webservice/#/Firstdesign', link: '/webservice/#/Firstdesign#Syntax', paragraph: 'JavaScript is a high-level, interpreted programming language. It is a language which is also characterized as dynamic, weakly typed, prototype-based and multi-paradigm. Alongside HTML and CSS, JavaScript is one of the three core technologies of World Wide Web content production; the majority of websites employ it, and all modern Web browsers support it without the need for plug-ins.' },
  { title: 'Rendering', excerpt: 'Rendering', url: '/webservice/#/Secondesign', link: '/webservice/#/Secondesign#Updates', paragraph: 'Unlike browser DOM elements, React elements are plain objects, and are cheap to create. React DOM takes care of updating the DOM to match the React elements. We call this a “root” DOM node because everything inside it will be managed by React DOM. Applications built with just React usually have a single root DOM node. If you are integrating React into an existing app, you may have as many isolated root DOM nodes as you like. To render a React element, first pass the DOM element to ReactDOM.createRoot, then pass the React element to root.render.'},
  { title: 'Components', excerpt: 'Components', url: '/webservice/#/Thirdesign', link: '/webservice/#/Thirdesign#Components', paragraph: 'Components let you split the UI into independent, reusable pieces, and think about each piece in isolation. This page provides an introduction to the idea of components.' },
  { title: 'State', excerpt: 'State', url: '/webservice/#/Fourdesign', link: '/webservice/#/Fourdesign#State', paragraph: 'Other thing to take in consideration, In React apps, whether a component is stateful or stateless is considered an implementation detail of the component that may change over time. You can use stateless components inside stateful components, and vice versa.' },
  { title: 'Events', excerpt: 'Events', url: '/webservice/#/Fivedesign', link: '/webservice/#/Fivedesign#Events', paragraph: 'When you are handling events with React elements is very similar to handling events on DOM elements. There are some syntax differences like, React events are named using camelCase, rather than lowercase, and with JSX you pass a function as the event handler, rather than a string. Another difference is that you cannot return false to prevent default behavior in React. You must call preventDefault explicitly. For example, with plain HTML, to prevent the default form behavior of submitting, take that in consideration. When using React, you generally donot need to call addEventListener to add listeners to a dOM element after it is created. Instead just provide a listener when the element is initially rendered I want to remaind you that you use onclick in remplace of event.' },
  { title: 'Starting', excerpt: 'Starting', url: '/webservice/#/Performancepatterns', link: '/webservice/#/Performancepatterns#Starting', paragraph: 'The JavaScript framework is used in various fields from the web to servers, and here is a quick list of the significant areas it is used on for instance to build Web Applications: As JavaScript is used for adding interactivity and automation to websites. So, if you want your web application to be anything more than just a static page of contents, you will probably need to do some JavaScript Also to build the Back-end Web Development: JavaScript has traditionally been used for developing the front-end parts of a web application. However, with the introduction of NodeJS, a prevalent back-end JavaScript framework, things have changed. And now, JavaScript is used for developing the back-end structure also.' },
  { title: 'JS Topics', excerpt: 'Topics', url: '/webservice/#/Staticimport', link: '/webservice/#/Staticimport#Array', paragraph: 'JavaScript is a high-level, interpreted programming language. It is a language which is also characterized as dynamic, weakly typed, prototype-based and multi-paradigm. Alongside HTML and CSS, JavaScript is one of the three core technologies of World Wide Web content production; the majority of websites employ it, and all modern Web browsers support it without the need for plug-ins.' }, 
  { title: 'JS Arrays', excerpt: 'Arrays', url: '/webservice/#/Dynamicimport', link: '/webservice/#/Dynamicimport#While', paragraph: 'In this article, we learned what a JavaScript loop is and looked at some examples. It is important to understand that there are many other types of loops, including the while loop, which is best used when you dont know the number of iterations Otherwise always use the for loop when you do know the number of iterations.' },
  { title: 'Web performance', excerpt: 'Objects', url: '/webservice/#/Renderingintro', link: '/webservice/#/Renderingintro#Abstract', paragraph: 'To summarize, many features impact performance including latency, application size, the number of DOM nodes, the number of resource requests made, JavaScript performance, CPU load, and more. It is important to minimize the loading and response times, and add additional features to conceal latency by making the experience as available and interactive as possible, as soon as possible, while asynchronously loading in the longer tail parts of the experience.' },
  { title: 'Rendering', excerpt: 'Rendering', url: '/webservice/#/Renderingclient', link: '/webservice/#/Renderingclient#Rendering', paragraph: 'To effectively understand web performance, the issues behind it, and the major topic areas we mentioned above, you really should understand some specifics about how browsers work.' },
  { title: 'Recomendations', excerpt: 'Recomendations', url: '/webservice/#/Renderingstatic', link: '/webservice/#/Renderingstatic#Reasons', paragraph: 'There are many reasons why your website should perform as well as possible. Below is a quick review of best practices, tools, APIs with links to provide more information about each topic.' },
]
